...
<head>
    ...
    <link rel="stylesheet" href="<?php print(_APP_URL); ?>/assets/css/style.css">
</head>
<body>
    <div class="container">
        <div>Zalogowano jako: <?php echo $_SESSION['username'] . ' (' . $_SESSION['role'] . ')'; ?></div>
        <a href="<?php print(_APP_URL); ?>/app/security/logout.php" class="logout-link">Wyloguj się</a>
